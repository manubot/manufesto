...
Currently, article processing charges (APCs, and/or subscription revenue) do not fund the intellectual contributions or creation of manuscripts.
...
Currently, journals do provide services that aren't entirely performed by unpaid volunteers.
...
Should publication be unbundled from journals, which provide these value-added services, APCs could fall dramatically [@doi:10.7287/peerj.preprints.27809v1].
